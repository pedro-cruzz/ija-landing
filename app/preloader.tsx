...
function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* AS CORDAS (SVG) */}
        <svg className="absolute w-[600px] h-[600px] -top-20 z-0 pointer-events-none opacity-60" viewBox="0 0 100 100">
            {/* Corda Esquerda */}
            <motion.path 
                d="M 50 50 Q 40 80 0 150" 
                animate={startExit ? { d: "M 50 50 L 0 150" } : { d: "M 50 50 Q 40 80 0 150" }}
            ...
            <motion.path 
                ...
                animate={startExit ? { d: "M 50 50 L 100 150" } : { d: "M 50 50 Q 60 80 100 150" }}
                transition={{ duration: 0.8, ease: "backIn" }}
                stroke="white" strokeWidth="0.5" fill="none"
            />
        </svg>
